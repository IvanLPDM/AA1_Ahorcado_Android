...
class EasyGamePlayActivity : AppCompatActivity() {

    var isNight = false;

    val word = "Ola"  // La palabra a adivinar (tiene que ser un parametro que reciba)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.easy_activity_game_play)
        ...
        val GamePlayLayout: View = findViewById(R.id.easyGamePlayLayout)
